class SHGT_transport_initializeHelicopterModule: Module_F
{
	scope = 2; // Editor visibility; 2 will show it in the menu, 1 will hide it.
	displayName = "Init Transport Helicopter"; // Name displayed in the menu
	...
	class ModuleDescription: ModuleDescription
{
	description[] =
	{
		"Sync this to a helicopter object with or without AI crew"
	};
	};
};