...
private _categoriesToSave = [];
{
	...
	if (_baseClass isEqualTo SHGT_persist_hqObjectName) then { _radiusToSave = SHGT_persist_radiusToSaveHq; _baseType = 'HQ';}; // if its a HQ
	if (_baseClass isEqualTo SHGT_persist_fobObjectName) then { _radiusToSave = SHGT_persist_radiusToSaveFob; _baseType = 'FOB';}; // if its a FOB
	if (_baseClass isEqualTo SHGT_persist_pbObjectName) then { _radiusToSave = SHGT_persist_radiusToSavepb; _baseType = 'PB';}; // if its a PB
