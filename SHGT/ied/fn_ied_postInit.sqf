...
{SHGT_ied_iedListAmmo pushBackUnique ([getText(configFile >> "CfgVehicles" >> _x >> "ammo")] select 0) } forEach SHGT_ied_iedList;
...
//SHGT_ied_iedAmmo = SHGT_ied_iedListAmmo;
//SHGT_ied_iedAmmo pushBackUnique SHGT_ied_vbedIedAmmo;
