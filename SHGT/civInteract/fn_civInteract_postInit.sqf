...
SHGT_civInteract_TOAR = ['QazakoJumat','KarShek','Gerdan','TaherKamar','EsaKhan','Darreh','AnbarTappeh']; // TOARs drawn on the editor map as markers of any type. Each marker is a town/area
SHGT_civInteract_TOARActive = ['QazakoJumat','KarShek','Gerdan','TaherKamar','EsaKhan','Darreh','AnbarTappeh']; // Only These towns will spawn ieds
...
SHGT_civInteract_IEDsUpdate = 120; // Time in minutes before a 'tick' is made to spawn more IEDs
...
SHGT_areaReputation set ['QazakoJumat', 100];
